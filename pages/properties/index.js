              ...
              <div className={styles.search}>
                <form action="">
                  ...
                  {props.properties
                    ...
                    .map(propers => (
                        <option key={propers.fields.featuredLocation} value={propers.fields.featuredLocation}>{propers.fields.featuredLocation}</option>
                    ))}
                  ...
                  <select id="propertytype" name="propertytype">
                    ...
                    .map(propers => (
                        <option key={propers.fields.propertyType} value={propers.fields.propertyType}>{propers.fields.propertyType}</option>
                    ))}
                  </select>
