    ...
    <div>
      <div className={styles['property-content']}>
        <div className={`property-container ${styles['property-body']}`}>
          ...
          <p className={styles.location}><i className='bx bx-map'></i>{props.propers.fields.featuredLocation}</p>
          ...
          <Carousel data-interval="false" className={styles['img-carousel']} >
            {props.propers.fields.featuredPictures.map(fp=>(
              <Carousel.Item  key={fp.fields.file.url}>
                <img className={styles['image-carousel']}
          ...
          <div className={`row ${styles['house-specifications']}`}>
            <div className={`col-8 ${styles['full-width']}`}>
              <div className="mt-4 d-flex flex-row">
                <div className="p-2">
                  <p id={styles.price}>₱ {props.propers.fields.featuredPrice.toLocaleString(undefined, {maximumFractionDigits:2})}
                    <span className={styles['gray-desc']}> Available </span> <span className={styles['gray-desc']}>Property Type: {props.propers.fields.propertyType}</span>
                  </p>
                </div>
              </div>
              <div className={styles['house-desc']}>
                <div className="row">
                  <div className="mb-4 col-6 ">
                    <span><svg className={styles['icons']} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35"
                      height="35" viewBox="0 0 172 172">
                      <g className={styles.icons} fill="none" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt"
            ...
            <div className={`col-4 ${styles['full-width']}`}>
              <div className={`mt-4 ${styles['shadow-sm']} ${styles.box}`}>
                ...
                <p id={styles.descBooking}> Our listings are in high demand, so don’t wait until your chance is over. </p>
                <button className={styles.btnBookViewing}>Book A Viewing</button>
              </div>
            </div>
          </div>
