          ...
          <div className={`row ${styles["house-specifications"]}`}>
            <div className={`col-8 ${styles["full-width"]}`}>
              ...
              <div className={styles["house-desc"]}>
                <div className="row">
                  {(props.propers.fields.featuredBedroom !== 0 ||
                    props.propers.fields.featuredBathroom !== 0) &&
                  ...
                  {props.propers.fields.floorArea !== 0 &&
                    props.propers.fields.floorArea && (
                      <div className="col-6 ">
                        ...
                        <span className={styles["spec-desc"]}>
                          <span className={styles["desc-num"]}>
                            {props.propers.fields.floorArea} m Floor Area
                          </span>
                        </span>
                      </div>
                    )}

                  {props.propers.fields.lotArea !== 0 &&
                    props.propers.fields.lotArea && (
                      <div className="col-6 ">
                        <span>
                          <svg
                            className={styles["icons"]}
                        ...
                        <span className={styles["spec-desc"]}>
                          <span className={styles["desc-num"]}>
                            {props.propers.fields.lotArea} m Lot Area
                          </span>
                        </span>
                      </div>
                    )}
